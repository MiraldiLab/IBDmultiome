...
#input results
file_df_results_ImmDict<-file.path(results_dir,paste('Downsample_statWald/PROGENy_CD64_ImmDict/CD_R/ImmDict_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_df_results_ImmDict_RNAEnrich<-file.path(results_dir,paste('Downsample_RNAEnrich/PROGENy_CD64_ImmDict/CD_R/ImmDict_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_df_results_CytoSig<-file.path(results_dir,paste('Downsample_statWald/CytoSig/CD_R/CytoSig_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_df_results_CytoSig_RNAEnrich<-file.path(results_dir,paste('Downsample_RNAEnrich/CytoSig/CD_R/CytoSig_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
...
heat_meta_col[['Database']] <- c('ImmDict'='#4C78A8','CytoSig'='#D04E3E')
heat_max_pval<-20
...
col_section <- gsub('_CD_R','',col_section)
...
file_out <- file.path(dir_out, paste0('heat_ImmDict_vs_CytoSig_top200_co_viz_fgsea_RNAEnrich_filter_Nsample_3_min_CD_R.pdf'))
