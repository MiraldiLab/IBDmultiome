...
file_df_gsea_PROGENy<-file.path(results_dir,paste('Downsample_statWald/PROGENy_CD64_ImmDict/UC_R/PROGENy_CD64_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_df_PROGENy_RNAEnrich<-file.path(results_dir,paste('Downsample_RNAEnrich/PROGENy_CD64_ImmDict/UC_R/PROGENy_CD64_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
