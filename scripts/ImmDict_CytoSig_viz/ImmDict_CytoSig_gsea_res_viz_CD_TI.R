...
file_gsea_ImmDict_RNAEnrich<-file.path(results_dir,paste('Downsample_RNAEnrich/PROGENy_CD64_ImmDict/CD_TI/ImmDict_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_df_order_cytokine_ImmDict<-file.path(results_dir,paste('Downsampled_fgsea_RNAEnrich_co_viz/CD_TI/sig_sets_ImmDict_cytokine_family_order.txt'))

file_gsea_CytoSig<-file.path(results_dir,paste('Downsample_statWald/CytoSig/CD_TI/CytoSig_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_gsea_CytoSig_RNAEnrich<-file.path(results_dir,paste('Downsample_RNAEnrich/CytoSig/CD_TI/CytoSig_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_df_order_cytokine_CytoSig<-file.path(results_dir,paste('Downsampled_fgsea_RNAEnrich_co_viz/CD_TI/sig_sets_CytoSig_cytokine_family_order.txt'))
...
meta[,'CellType']<-gsub('_CD_TI','',meta[,'CellType'])
...
df_Nsample<-df_Nsample[df_Nsample$DiseaseTissue=='CD_TI',]
...
file_out <- file.path(dir_out, paste0('heat_',file_save,'_sig_cytokine_FDR10_ImmDict_CytoSig_viz_sig_fgsea_RNAEnrich_Nsample_3_filter_CD_TI.pdf'))
