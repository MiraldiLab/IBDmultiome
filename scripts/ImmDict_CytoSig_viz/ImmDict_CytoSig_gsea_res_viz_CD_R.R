...
#input files
file_gsea_ImmDict<-file.path(results_dir,paste('Downsample_statWald/PROGENy_CD64_ImmDict/CD_R/ImmDict_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_ImmDict_RNAEnrich<-file.path(results_dir,paste('Downsample_RNAEnrich/PROGENy_CD64_ImmDict/CD_R/ImmDict_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_df_order_cytokine_ImmDict<-file.path(results_dir,paste('Downsampled_fgsea_RNAEnrich_co_viz/CD_R/sig_sets_ImmDict_cytokine_family_order_by_max_log10Padj.txt'))

file_gsea_CytoSig<-file.path(results_dir,paste('Downsample_statWald/CytoSig/CD_R/CytoSig_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_CytoSig_RNAEnrich<-file.path(results_dir,paste('Downsample_RNAEnrich/CytoSig/CD_R/CytoSig_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_df_order_cytokine_CytoSig<-file.path(results_dir,paste('Downsampled_fgsea_RNAEnrich_co_viz/CD_R/sig_sets_CytoSig_cytokine_family_order_by_max_log10Padj.txt'))
...
ImmDict_RNAEnrich<-read.table(file_ImmDict_RNAEnrich,sep='\t',header=T,check.names=F)
ImmDict_RNAEnrich<-ImmDict_RNAEnrich[ImmDict_RNAEnrich$Context%in%order_clustersubtype,]
...
ImmDict_RNAEnrich<-ImmDict_RNAEnrich[ImmDict_RNAEnrich$Pathway%in%order_cytokine_ImmDict,]
#CytoSig results
...
CytoSig_RNAEnrich<-read.table(file_CytoSig_RNAEnrich,sep='\t',header=T,check.names=F)
CytoSig_RNAEnrich<-CytoSig_RNAEnrich[CytoSig_RNAEnrich$Context%in%order_clustersubtype,]
...
CytoSig_RNAEnrich<-CytoSig_RNAEnrich[CytoSig_RNAEnrich$Pathway%in%order_cytokine_CytoSig,]
...
df_viz_padj_CytoSig_RNAEnrich <- acast(CytoSig_RNAEnrich, Pathway ~ Context, value.var = "-log10Padj")
...
meta[,'CellType']<-gsub('_CD_R','',meta[,'CellType'])
...
label_celltype <- gsub('_CD_R','',label_celltype)
...
df_Nsample<-df_Nsample[df_Nsample$DiseaseTissue=='CD_R',]
...
file_out <- file.path(dir_out, paste0('heat_',file_save,'_sig_cytokine_FDR10_ImmDict_CytoSig_viz_sig_fgsea_RNAEnrich_Nsample_3_filter_CD_R.pdf'))
