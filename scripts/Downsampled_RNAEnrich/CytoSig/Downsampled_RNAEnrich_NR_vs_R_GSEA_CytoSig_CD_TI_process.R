...
# input date object
file_gsea<-file.path(results_dir,paste('Downsample/1Factor_CellType_Downsample_RNAEnrich/CD_TI/CytoSig/gsea_IBD_multiome_CytoSig_I_vs_NI_Disease_Tissue_All.rds'))
file_sig_sets<-file.path(results_dir,paste('Downsample/1Factor_CellType_Downsample_RNAEnrich/CD_TI/CytoSig/sig_setsIBD_multiome_CytoSig_All.txt'))
...
# output directories
dir_out <- file.path(project_dir, "results","GSEA_RNA_Status", "Downsample_RNAEnrich", "CytoSig", "CD_TI")
