...
file_gsea_ImmDict<-file.path(results_dir,paste('Downsample/1Factor_CellType_Downsample_RNAEnrich/CD_R/final_ImmDict_max200/gsea_IBD_multiome_final_ImmDict_max200_I_vs_NI_Disease_Tissue_All.rds'))
file_sig_sets_ImmDict<-file.path(results_dir,paste('Downsample/1Factor_CellType_Downsample_RNAEnrich/CD_R/final_ImmDict_max200/sig_setsIBD_multiome_final_ImmDict_max200_All.txt'))
file_gsea_PROGENy_CD64<-file.path(results_dir,paste('Downsample/1Factor_CellType_Downsample_RNAEnrich/CD_R/final_PROGENy_CD64_max200/gsea_IBD_multiome_final_PROGENy_CD64_max200_I_vs_NI_Disease_Tissue_All.rds'))
file_sig_sets_PROGENy_CD64<-file.path(results_dir,paste('Downsample/1Factor_CellType_Downsample_RNAEnrich/CD_R/final_PROGENy_CD64_max200/sig_setsIBD_multiome_final_PROGENy_CD64_max200_All.txt'))
...
# output directories
dir_out <- file.path(project_dir, "results","GSEA_RNA_Status", "Downsample_RNAEnrich","PROGENy_CD64_ImmDict", "CD_R")
