...
file_gsea_PROGENy_CD64<-file.path(results_dir,paste('Downsample_statWald/PROGENy_CD64_ImmDict/CD_R/PROGENy_CD64_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_gsea_PROGENy_CD64_RNAEnrich<-file.path(results_dir,paste('Downsample_RNAEnrich/PROGENy_CD64_ImmDict/CD_R/PROGENy_CD64_I_vs_NI_-log10_Padj_all_cytokine_df_frac_L_R_by_pathway.txt'))
file_order_cytokine_PROGENy<-file.path(results_dir,paste('Downsampled_fgsea_RNAEnrich_co_viz/CD_R/sig_sets_PROGENy_cytokine_order_by_max_log10Padj.txt'))
...
label_celltype<-gsub('Immature_Goblet','Imm.Goblet',label_celltype)
...
file_out <- file.path(dir_out, paste0('heat_',file_save,'_sig_cytokine_FDR10_PROGENy_CD64_viz_sig_fgsea_RNAEnrich_Nsample_3_filter_CD_R.pdf'))
